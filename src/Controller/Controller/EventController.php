...
use App\Form\Form\Event\EventDetailsTypeForm;
use App\Form\Form\Event\EventInviationsTypeForm;
use App\Form\Form\Event\EventLocationTypeForm;
use App\Form\Form\EventParticipantTypeForm;
...
class EventController extends AbstractController
{
    ...
    public function show(Event $event, Request $request, #[CurrentUser] User $currentUser): Response
    {
        ...
        $eventParticipantForm = $this->createForm(EventParticipantTypeForm::class, $eventParticipant);
    ...
    private function renderEventCreateFromStepOne(): FormInterface
    {
        ...
        return $this->createForm(EventDetailsTypeForm::class, $eventDetailsDto);
    }
    ...
    private function renderEventCreateFromStepTwo(): FormInterface
    {
        ...
        return $this->createForm(EventLocationTypeForm::class, $eventLocationDto);
    }
    ...
    private function renderEventCreateFromStepThree(): FormInterface
    {
        ...
        return $this->createForm(EventInviationsTypeForm::class, $eventInviationsDto);
    }
